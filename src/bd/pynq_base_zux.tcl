...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD] [get_bd_intf_pins axi_smc/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps_top_M08_AXI [get_bd_intf_pins M08_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps_top_M09_AXI [get_bd_intf_pins M09_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ps8_0_axi_periph/S02_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins axi_smc/aresetn]
...
proc create_hier_cell_bin_counter_top { parentCell nameHier } {
  ...
  set axi_gpio_bin_cnt [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_bin_cnt ]
...
proc create_hier_cell_fiberio_top { parentCell nameHier } {
  ...
  set axi_gpio_fiberio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_fiberio ]
  set_property -dict [list \
  ...
  set xlconcat_fiberio_input [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat xlconcat_fiberio_input ]
...
proc create_hier_cell_userio_top { parentCell nameHier } {
  ...
  set axi_gpio_userio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_userio ]
  set_property -dict [list \
    CONFIG.C_ALL_INPUTS {1} \
    CONFIG.C_ALL_OUTPUTS_2 {1} \
  ...
  set xlconcat_userio_input [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat xlconcat_userio_input ]
...
proc create_hier_cell_led_pl_top { parentCell nameHier } {
  ...
  set sys_ila_led_pl [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila sys_ila_led_pl ]
  set_property -dict [list \
  ...
  set axi_gpio_led_pl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_led_pl ]
  set_property -dict [list \
...
proc create_hier_cell_intc_top { parentCell nameHier } {
  ...
  set axi_gpio_int_trig_in0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_int_trig_in0 ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_GPIO_WIDTH {1} \
  ...
  set sys_ila_intc [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila sys_ila_intc ]
  set_property -dict [list \
    CONFIG.C_MON_TYPE {MIX} \
...
proc create_hier_cell_dma_loopback_top { parentCell nameHier } {
  ...
  set sys_ila_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila sys_ila_dma ]
  set_property -dict [list \
    CONFIG.C_MON_TYPE {MIX} \
  ...
  set axis_fifo_data_counts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axis_fifo_data_counts ]
  set_property -dict [list \
    CONFIG.C_ALL_INPUTS {1} \
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces dma_loopback_top/axi_dma_0/Data_MM2S] [get_bd_addr_segs ps_top/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces dma_loopback_top/axi_dma_0/Data_S2MM] [get_bd_addr_segs ps_top/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  ...
  # Exclude Address Segments (only valid combinations)
